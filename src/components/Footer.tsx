    ...
    <footer className="bg-cream-900 text-cream-300">
      <section className="border-b border-cream-800">
        <div className="container-main py-10 max-w-lg text-center">
          <p className="text-xs uppercase tracking-widest text-cream-500 mb-3">Read me on Substack</p>
          ...
          <a
            ...
            className="btn-primary !bg-cream-500 hover:!bg-cream-400 whitespace-nowrap text-xs plausible-event-name=Substack+Click+Footer"
          >
      ...
      <div className="container-main py-14">
        ...
        <div className="border-t border-cream-800 mt-10 pt-7">
          ...
          <div className="flex flex-wrap gap-x-4 gap-y-2 text-xs leading-relaxed">
            ...
            <Link href="/mens-work/#real-for-men" className="text-cream-500 hover:text-cream-200 transition-colors">R.E.A.L. for Men</Link>
