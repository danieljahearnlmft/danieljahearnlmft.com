    ...
    <>
      <section className="bg-cream-800 py-16 md:py-24">
        <div className="container-main max-w-3xl">
          <p className="eyebrow text-cream-400">Clinical Approach</p>
      ...
      <section className="section-warm">
        <div className="container-main max-w-3xl">
          ...
          <h2 className="text-3xl font-serif text-cream-900 mb-6">The mechanism of change</h2>
          <p className="text-cream-700 leading-relaxed mb-5">
      ...
      <section className="section-cream">
        <div className="container-main max-w-3xl">
          <p className="eyebrow">What a Session Looks Like</p>
          <h2 className="text-3xl font-serif text-cream-900 mb-6">Inside the work</h2>
          <p className="text-cream-700 leading-relaxed mb-5">
      ...
      <section className="section-warm">
        <div className="container-main max-w-3xl">
          ...
          <h2 className="text-3xl font-serif text-cream-900 mb-6">The right fit</h2>
          <p className="text-cream-700 leading-relaxed mb-5">
      ...
      <section className="bg-cream-800 py-14">
        <div className="container-main max-w-2xl text-center">
          ...
          <h2 className="text-2xl font-serif text-cream-100 mb-4">Begin the work</h2>
          <p className="text-cream-400 leading-relaxed mb-7">
            I am an IAT-certified clinician trained directly with Dr. Daniel P. Brown and Dr. David Elliott. I work with adults and parents in private practice in Los Angeles.
          </p>
